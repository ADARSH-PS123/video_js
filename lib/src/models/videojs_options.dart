...
final String ? preload;
  ...
  // add package for handling hot key
final Map<String,dynamic> ? hotkeyParameter;

  VideoJsOptions(

      {  this.hotkeyParameter, 
          this.autoplay, 
        this.controls,
        this.preload,
      this.loop,
  ...
  Map<String, dynamic> toJson() {
    ...
    if(preload !=null)data['preload'] ='"$preload"';
    if(hotkeyParameter !=null)data['plugins']=hotkeyParameter!['plugins'];
    data['html5']= {
        'hls': {
